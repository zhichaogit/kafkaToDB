...
#java -cp bin:bin/*:libs/* KafkaCDC -p 2 -b 192.168.0.71:9092 -d 192.168.0.71 -g 1 -s SEABASE -t test -f Unicom --full --sto 30000
#java -cp bin:bin/*:libs/* KafkaCDC -p 1 -b 192.168.0.71:9092 -d 192.168.0.71 -g 1 -s SEABASE -t test5 -f Unicom --full --sto 3 --interval 2
#java -cp bin:bin/*:libs/* KafkaCDC -p "2-3" -b 192.168.0.71:9092 -d 192.168.0.71 -g 1 -s SEABASE -t test -f Unicom --full --sto 3 --interval 2
...
#java -cp bin:bin/*:libs/* KafkaCDC -p 1 -b 192.168.0.71:9092 -d 192.168.0.71 -g 1 -s SEABASE --table g_ad -t t_can -f HongQuan --full --sto 5 --interval 2  --key org.apache.kafka.common.serialization.LongDeserializer --value org.apache.kafka.common.serialization.ByteArrayDeserializer