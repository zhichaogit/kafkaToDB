package com.esgyn.kafkaCDC.JsonFormat;
...
public class CustomFormatTest extends RowMessage<String>{
    private static Logger log = Logger.getLogger(CustomFormatTest.class);
    ...
    String   message = null;
    public CustomFormatTest() {}
    public CustomFormatTest(MessageTypePara<String> mtpara) throws UnsupportedEncodingException {
        init(mtpara);
