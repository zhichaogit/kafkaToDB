...
echo "$TOPDIR/template $PARTITION $BROKER $DBIP $TOPIC \"Unicom\" $DESTSCHEMA $DESTSCHEMA $TABLE2 $TABLE1 $TABLE1 $TABLE1 $KAFKA_CDC/$CONFIG"
$TOPDIR/template $PARTITION $BROKER $DBIP $TOPIC "Unicom" $DESTSCHEMA $DESTSCHEMA $TABLE2 $TABLE1 $TABLE1 $TABLE1 $KAFKA_CDC/$CONFIG
